...
class User(AbstractUser):
    bio = models.TextField(max_length=500, blank=True,
                           verbose_name='Descripcion', null=True)
    ciudad = models.CharField(
        max_length=150, blank=True, verbose_name='Direccion')
    provincia = models.CharField(max_length=1, verbose_name='Provicia')
    ...
    cuit = models.CharField(
        max_length=13, verbose_name='CUIT', blank=True, null=True)
